...
class MRTf_Idf(MRJob):
    ...
    def sesiones(self,key,value):
        ...
        for word in value:
            ...
            pagina=word[2]
            codigo=word[3]
            yield (ip,sesion), [ip,word[1],pagina,codigo]
    ...
    def behevier(self,key,value):
        ...
        #ordenamos la lista para que los comportamientos [a,b,c] sea al mismo a [c,a,b]
        behevierf.sort()
